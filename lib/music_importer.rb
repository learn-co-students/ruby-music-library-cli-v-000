class MusicImporter
  ...
  attr_reader :path
    ...
    #you don't even need Song.create_from_filename -> it will know about it because it searches through Classes. Link is done through the require in the environemnt
    def import
      files.each { |filo| create_from_filename(filo) }
    end
