class Song
  ...
  def self.all #returns whatever is inside the array, exposes song class and the variable all
    @@all 
  end
  ...
  def save # call save on an instance of a song and it adds the instance which is what self references 
    @@all << self
  end
