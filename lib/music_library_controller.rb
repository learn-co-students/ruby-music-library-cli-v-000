class MusicLibraryController
  ...
  def call
    loop do
      puts "Welcome to Your Music Library! Ready to jam?"
      puts "Please enter one of the following: 'list songs', 'list artists', 'list genres', 'play song', 'list artist' and 'list genre' "
      input = gets.chomp
