class MusicLibraryController
  ...
  def list_songs ## Go over this method
  ...
  def list_songs_by_genre
    ...
    if Genre.find_by_name(user_input)
      ...
      genre.songs.sort_by { |genre| genre.name }.each_with_index do |genre, index|
  ...
  def play_song
    ...
    if user_input.between?(1, Song.all.size)
      ...
      song = sorted_songs[user_input - 1].name
      artist = sorted_songs[user_input - 1].artist.name
