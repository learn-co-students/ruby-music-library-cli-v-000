...
describe "MusicLibraryController" do
  ...
  describe "#call" do
    ...
    it "welcomes the user" do
      ...
      expect($stdout).to receive(:puts).with("To list all of the songs by a particular artist, enter 'list by artist'.")
      expect($stdout).to receive(:puts).with("To list all of the songs of a particular genre, enter 'list by genre'.")
