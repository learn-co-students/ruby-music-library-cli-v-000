describe 'Music Library CLI' do
  ...
  it 'allows a user to list songs' do
    ...
    expect(output).to include("2. Real Estate - It's Real - hip-hop")
    expect(output).to include("3. Thundercat - For Love I Come - dance")
  ...
  it 'allows a user to play a song' do
    ...
    expect(output).to include("Playing Real Estate - Green Aisles - country")
  end
